...
(function() {
  var RequestUrIs, buyPlayzoneItem, debuglog, getGamebarRanklist, getInfo, getMultiInfo, getPlayzoneUserinfo, helps, isLogin, request, sendGamebarMsg, setAchievement, _makeReqOptions;
  ...
  _makeReqOptions = function(self, uri, method, params) {
    var options;
    params.appid = self.appid;
    params.pf || (params.pf = self.pf);
    params.format || (params.format = self.format);
  ...
  getInfo = function(params, callback) {
    var options;
    options = _makeReqOptions(this, RequestUrIs.GET_INFO_URI, "POST", params);
    console.dir(options);
  ...
  getMultiInfo = function(params, callback) {
    var options;
    options = _makeReqOptions(this, RequestUrIs.GET_MULTI_INFO_URI, "POST", params);
    console.dir(options);
    request(options, function(err, res, body) {
      if (err != null) {
        return callback(err);
  ...
  setAchievement = function(params, callback) {
    var options;
    options = _makeReqOptions(this, RequestUrIs.SET_ACHIEVEMENT_URI, "POST", params);
    console.dir(options);
    request(options, function(err, res, body) {
      if (err != null) {
        return callback(err);
  ...
  getGamebarRanklist = function(params, callback) {
    var options;
    options = _makeReqOptions(this, RequestUrIs.GET_GAMEBAR_RANKLIST_URI, "POST", params);
    console.dir(options);
    request(options, function(err, res, body) {
      if (err != null) {
        return callback(err);
  ...
  buyPlayzoneItem = function(params, callback) {
    var options;
    options = _makeReqOptions(this, RequestUrIs.BUY_PLAYZONE_ITEM_URI, "POST", params);
    console.dir(options);
    request(options, function(err, res, body) {
      if (err != null) {
        return callback(err);
  ...
  getPlayzoneUserinfo = function(params, callback) {
    var options;
    options = _makeReqOptions(this, RequestUrIs.GET_PLAYZONE_USERINFO_URI, "POST", params);
    console.dir(options);
    request(options, function(err, res, body) {
      if (err != null) {
        return callback(err);
  ...
  sendGamebarMsg = function(params, callback) {
    var options;
    options = _makeReqOptions(this, RequestUrIs.SEND_GAMEBAR_MSG, "POST", params);
    console.dir(options);
    request(options, function(err, res, body) {
      if (err != null) {
        return callback(err);
