...
(function() {
  var RequestUrIs, debuglog, getAchievement, getGamebarRanklist, helps, request, setAchievement, verifyInvkey, _makeReqOptions;
  ...
  getAchievement = function(params, method, callback) {
    var options;
    if (method == null) {
      method = "POST";
    }
    options = _makeReqOptions(this, RequestUrIs.GET_ACHIEVEMENT_URI, method, params);
    request(options, function(err, res, body) {
      if (err != null) {
        return callback(err);
      }
  ...
  verifyInvkey = function(params, method, callback) {
    var options;
    if (method == null) {
      method = 'POST';
    }
    options = _makeReqOptions(this, RequestUrIs.VERIFY_INVKEY_URI, method, params);
    request(options, function(err, res, body) {
      var isRight;
      if (err != null) {
        return callback(err);
